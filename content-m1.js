...
`,
  ...
  /* Практикум по CASE WHEN — тем же форматом, что в 1.2 (см. там).
...
<p>Город хранится в <code>users</code>, поэтому понадобится <code>JOIN</code> из урока 1.1. Дальше — группировка по городу, как в шаге 4, и подсчёт по условию, как в шаге 5.</p>`,
