...
self.addEventListener("install", function (e) {
  /* Новая версия складывает оболочку в свой кеш и сразу встаёт на
     место старой. Ждать закрытия всех вкладок нельзя: обычное
     «обновить страницу» вкладку не закрывает, и ученик неделями
     видел бы прежний курс. Открытая страница дорабатывает со своим
     кодом в памяти, следующая загрузка — уже новая версия. */
